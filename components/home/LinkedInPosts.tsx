      ...
      <Container>
        <div className="mb-12">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl">
            A look into the last two years studying IT & product design at southern university of Denmark, in Kolding. A study where, we've had focus on designing real solutions with stakeholders across different industries. Below you can see some of the projects I've worked on during the studies.
          </p>
        </div>
