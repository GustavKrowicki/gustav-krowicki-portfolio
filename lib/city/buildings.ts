...
export const BUILDINGS: Record<string, BuildingDefinition> = {
  ...
  "erhvervsakademiet": {
    ...
    sprites: {
      ...
      north: "/game/pogicity/Building/landmark/erhvervsakademiet _north.png",
      east: "/game/pogicity/Building/landmark/erhvervsakademiet _east.png",
      west: "/game/pogicity/Building/landmark/erhvervsakademiet _west.png",
    },
    icon: "🏫",
